...
const StatsInfoCard = ({icon,label,value,color}) =>{
       return(
        <div className='flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-950 relative'>
        ...
        <div className='hidden md:block w-[40vw] h-scrren bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
            ...
            <div className='w-48 h-48 rounded-[40px] bg-purple-600 absolute -bottom-7 -left-5' />
             <div className='grid grid-cols-1 z-20 '>
                 <StatsInfoCard icon={<LuTrendingUpDown/>} label="Track Your Expenses" value="430,000" color="bg-primary" />
             </div>
            <img className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-950 ' src={CARD_2} alt="car_image_404" />
        </div>
    </div>
  )
}
