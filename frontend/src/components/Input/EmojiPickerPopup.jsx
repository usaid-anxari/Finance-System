    ...
    <div className="flex flex-col md:flex-row items-start gap-5 mb-6 ">
      ...
      {isOpen && (
        <div className="relative">
            <button className="w-7 h-7  items-center justify-center bg-white border border-gray-200 rounded-full absolute -top-2 -right-2 z-10 cursor-pointer " onClick={()=> setIsOpen(false)}><LuX/></button>
